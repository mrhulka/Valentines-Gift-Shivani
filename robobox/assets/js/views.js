    ...
    UI.table(host.querySelector('#t'), {
      ...
      columns: [
        ...
        { key: 'proposals', label: 'Proposals', num: true,
          get: function (r) { return r.life.views.filter(function (v) { return v.stageRank >= M.RANK.Proposal; }).length; },
          render: function (r) { return U.count(r.life.views.filter(function (v) { return v.stageRank >= M.RANK.Proposal; }).length); } },
